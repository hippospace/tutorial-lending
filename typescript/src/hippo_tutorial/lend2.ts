...
export class FreeCoins 
{
  ...
  { name: "btc_cap", typeTag: new StructTag(new HexString("0x1"), "coin", "MintCapability", [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]) },
  { name: "eth_cap", typeTag: new StructTag(new HexString("0x1"), "coin", "MintCapability", [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]) },
  { name: "usdc_cap", typeTag: new StructTag(new HexString("0x1"), "coin", "MintCapability", [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]) },
  { name: "usdt_cap", typeTag: new StructTag(new HexString("0x1"), "coin", "MintCapability", [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]) },
...
export function admin_add_pool_ (
  ...
  if (!!$c.exists(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPoolReserve", [$p[0]]), Std.Signer.address_of_(admin, $c))) {
    throw $.abortCode(u64("1001"));
  }
  if (!Aptos_framework.Coin.is_coin_initialized_($c, [$p[0]])) {
    throw $.abortCode(u64("1002"));
  }
  protocol = $c.borrow_global_mut<LendingProtocol>(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingProtocol", []), new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"));
  pool_id = Std.Vector.length_(protocol.pools, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPool", [])]);
  coin_type = Aptos_std.Type_info.type_of_($c, [$p[0]]);
  pool = new LendingPool({ pool_id: $.copy(pool_id), coin_type: $.copy(coin_type), coin_price: $.copy(initial_price), total_deposit: u64("0"), total_borrow: u64("0") }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPool", []));
  $c.move_to(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPoolReserve", [$p[0]]), admin, new LendingPoolReserve({ reserve: Aptos_framework.Coin.zero_($c, [$p[0]]) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPoolReserve", [$p[0]])));
  Std.Vector.push_back_(protocol.pools, pool, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPool", [])]);
...
export function buildPayload_admin_add_pool (
  ...
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::admin_add_pool",
    typeParamStrings,
    [
...
export function admin_init_ (
  ...
  return $c.move_to(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingProtocol", []), admin, new LendingProtocol({ users: Std.Vector.empty_($c, [AtomicTypeTag.Address]), pools: Std.Vector.empty_($c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPool", [])]), pool_index: Aptos_std.Table.new___($c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), AtomicTypeTag.U64]) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingProtocol", [])));
}
...
export function buildPayload_admin_init (
  ...
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::admin_init",
    typeParamStrings,
    []
  );
...
export function admin_update_price_ (
  ...
  pool = Std.Vector.borrow_mut_(protocol.pools, $.copy(pool_id), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPool", [])]);
...
export function buildPayload_admin_update_price (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::admin_update_price",
    typeParamStrings,
    [
      $.payloadArg(price),
    ]
...
export function borrow_ (
  ...
  pool_id = $.copy(Aptos_std.Table.borrow_(protocol.pool_index, $.copy(coin_type), $c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), AtomicTypeTag.U64]));
  pool = Std.Vector.borrow_mut_(protocol.pools, $.copy(pool_id), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPool", [])]);
  reserve = $c.borrow_global_mut<LendingPoolReserve>(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingPoolReserve", [$p[0]]), new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"));
  user_assets = $c.borrow_global_mut<User>(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "User", []), Std.Signer.address_of_(user, $c));
...
export function buildPayload_borrow (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::borrow",
    typeParamStrings,
    [
      $.payloadArg(amount),
    ]
...
export function create_fake_user1_ (
  ...
  deposit_(user, u64("10000000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  deposit_(user, u64("10000000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  deposit_(user, u64("10000000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  deposit_(user, u64("10000000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]);
  return;
}
...
export function buildPayload_create_fake_user1 (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::create_fake_user1",
    typeParamStrings,
    []
  );
...
export function create_fake_user2_ (
  ...
  init_coin_stores_(user, $c);
  deposit_(user, u64("100"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  deposit_(user, u64("100"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  borrow_(user, u64("100"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  return;
}
...
export function buildPayload_create_fake_user2 (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::create_fake_user2",
    typeParamStrings,
    []
  );
...
export function create_fake_user3_ (
  ...
  deposit_(user, u64("100"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  deposit_(user, u64("100"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  borrow_(user, u64("800000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  return;
}
...
export function buildPayload_create_fake_user3 (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::create_fake_user3",
    typeParamStrings,
    []
  );
...
export function buildPayload_deposit (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::deposit",
    typeParamStrings,
    [
      $.payloadArg(amount),
    ]
...
export function ensure_user_exists_ (
  ...
  if (!$c.exists(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "User", []), Std.Signer.address_of_(user, $c))) {
    Std.Vector.push_back_(protocol.users, Std.Signer.address_of_(user, $c), $c, [AtomicTypeTag.Address]);
    $c.move_to(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "User", []), user, new User({ deposits: Aptos_std.Iterable_table.new___($c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "DepositPosition", [])]), borrows: Aptos_std.Iterable_table.new___($c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "BorrowPosition", [])]) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "User", [])));
  }
  else{
  }
  return;
...
export function get_all_users_ (
  ...
  protocol = $c.borrow_global<LendingProtocol>(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "LendingProtocol", []), new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"));
  i = u64("0");
  len = Std.Vector.length_(protocol.users, $c, [AtomicTypeTag.Address]);
  list = new AllUserInfo({ healthy_users: Std.Vector.empty_($c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "UserInfo", [])]), unhealthy_users: Std.Vector.empty_($c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "UserInfo", [])]) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "AllUserInfo", []));
  while (($.copy(i)).lt($.copy(len))) {
    {
      user_addr = Std.Vector.borrow_(protocol.users, $.copy(i), $c, [AtomicTypeTag.Address]);
      user = $c.borrow_global<User>(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "User", []), $.copy(user_addr));
      [is_healthy, borrow_value, deposit_value] = user_get_limits_(user, protocol, $c);
      user_info = new UserInfo({ address: $.copy(user_addr), deposits: get_values_(user.deposits, $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "DepositPosition", [])]), borrows: get_values_(user.borrows, $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "BorrowPosition", [])]), borrow_value: $.copy(borrow_value), deposit_value: $.copy(deposit_value), is_healthy: is_healthy }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "UserInfo", []));
      if (is_healthy) {
        Std.Vector.push_back_(list.healthy_users, user_info, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "UserInfo", [])]);
      }
      else{
        Std.Vector.push_back_(list.unhealthy_users, user_info, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "UserInfo", [])]);
      }
      i = ($.copy(i)).add(u64("1"));
    }

  }return $c.move_to(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "AllUserInfo", []), initiator, list);
}
...
export function buildPayload_get_all_users (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::get_all_users",
    typeParamStrings,
    []
  );
...
export async function query_get_all_users(
  ...
  const outputTypeTag = new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "AllUserInfo", []);
...
export function init_coin_stores_ (
  ...
  Aptos_framework.Coins.register_internal_(user, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  Aptos_framework.Coins.register_internal_(user, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  Aptos_framework.Coins.register_internal_(user, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  Aptos_framework.Coins.register_internal_(user, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]);
  faucet_amount = u64("1000000000");
  free_coins = $c.borrow_global_mut<FreeCoins>(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FreeCoins", []), new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"));
  btc = Aptos_framework.Coin.extract_(free_coins.btc_coin, $.copy(faucet_amount), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  eth = Aptos_framework.Coin.extract_(free_coins.eth_coin, $.copy(faucet_amount), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  usdc = Aptos_framework.Coin.extract_(free_coins.usdc_coin, $.copy(faucet_amount), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  usdt = Aptos_framework.Coin.extract_(free_coins.usdt_coin, $.copy(faucet_amount), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]);
  addr = Std.Signer.address_of_(user, $c);
  Aptos_framework.Coin.deposit_($.copy(addr), btc, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  Aptos_framework.Coin.deposit_($.copy(addr), eth, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  Aptos_framework.Coin.deposit_($.copy(addr), usdc, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  Aptos_framework.Coin.deposit_($.copy(addr), usdt, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]);
  return;
}
...
export function init_fake_pools_ (
  ...
  [btc_cap, btc_burn] = Aptos_framework.Coin.initialize_(admin, $.copy(name), $.copy(name), u64("0"), false, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  [eth_cap, eth_burn] = Aptos_framework.Coin.initialize_(admin, $.copy(name), $.copy(name), u64("0"), false, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  [usdc_cap, usdc_burn] = Aptos_framework.Coin.initialize_(admin, $.copy(name), $.copy(name), u64("0"), false, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  [usdt_cap, usdt_burn] = Aptos_framework.Coin.initialize_(admin, $.copy(name), $.copy(name), u64("0"), false, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]);
  mint_amount = u64("1000000000000");
  $c.move_to(new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FreeCoins", []), admin, new FreeCoins({ btc_coin: Aptos_framework.Coin.mint_($.copy(mint_amount), btc_cap, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]), eth_coin: Aptos_framework.Coin.mint_($.copy(mint_amount), eth_cap, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]), usdc_coin: Aptos_framework.Coin.mint_($.copy(mint_amount), usdc_cap, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]), usdt_coin: Aptos_framework.Coin.mint_($.copy(mint_amount), usdt_cap, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]), btc_cap: $.copy(btc_cap), eth_cap: $.copy(eth_cap), usdc_cap: $.copy(usdc_cap), usdt_cap: $.copy(usdt_cap), btc_burn: $.copy(btc_burn), eth_burn: $.copy(eth_burn), usdc_burn: $.copy(usdc_burn), usdt_burn: $.copy(usdt_burn) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FreeCoins", [])));
  admin_init_(admin, $c);
  admin_add_pool_(admin, u64("10000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  admin_add_pool_(admin, u64("1000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  admin_add_pool_(admin, u64("1"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDC", [])]);
  admin_add_pool_(admin, u64("1"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeUSDT", [])]);
  return;
}
...
export function buildPayload_init_fake_pools (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::init_fake_pools",
    typeParamStrings,
    []
  );
...
export function make_borrow_ (
  ...
  if (!Aptos_std.Iterable_table.contains_(user.borrows, $.copy(pool_id), $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "BorrowPosition", [])])) {
    Aptos_std.Iterable_table.add_(user.borrows, $.copy(pool_id), new BorrowPosition({ pool_id: $.copy(pool_id), borrow_amount: $.copy(amount) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "BorrowPosition", [])), $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "BorrowPosition", [])]);
  }
  else{
    position = Aptos_std.Iterable_table.borrow_mut_(user.borrows, $.copy(pool_id), $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "BorrowPosition", [])]);
...
export function make_deposit_ (
  ...
  if (!Aptos_std.Iterable_table.contains_(user.deposits, $.copy(pool_id), $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "DepositPosition", [])])) {
    Aptos_std.Iterable_table.add_(user.deposits, $.copy(pool_id), new DepositPosition({ pool_id: $.copy(pool_id), deposit_amount: $.copy(amount) }, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "DepositPosition", [])), $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "DepositPosition", [])]);
  }
  else{
    position = Aptos_std.Iterable_table.borrow_mut_(user.deposits, $.copy(pool_id), $c, [AtomicTypeTag.U64, new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "DepositPosition", [])]);
...
export function price_drop_ (
  ...
  admin_update_price_(admin, u64("5000"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeBTC", [])]);
  admin_update_price_(admin, u64("500"), $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "lend2", "FakeETH", [])]);
  return;
}
...
export function buildPayload_price_drop (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::price_drop",
    typeParamStrings,
    []
  );
...
export function buildPayload_repay (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::repay",
    typeParamStrings,
    [
      $.payloadArg(amount),
    ]
...
export function buildPayload_withdraw (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a::lend2::withdraw",
    typeParamStrings,
    [
      $.payloadArg(amount),
    ]
